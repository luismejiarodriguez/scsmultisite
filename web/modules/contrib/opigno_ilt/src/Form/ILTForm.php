...
class ILTForm extends ContentEntityForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($training !== NULL) {
      ...
      if ($trainer_id) {
        $trainer = $this->userStorage->load($trainer_id);
      ...
      $form['actions'] = [
        '#markup' => $this->t('ILTs can only be added as part of a training. Please visit the training where you want to add an ILT and add it from the management interface'),
      ];
    }
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $params = [];
    $params['subject'] = $params['message'] = $this->t('Created new Instructor Led Training %meeting', [
    ...
    if ($status == SAVED_UPDATED) {
      ...
      $users = $this->userStorage->loadMultiple($users_ids);
