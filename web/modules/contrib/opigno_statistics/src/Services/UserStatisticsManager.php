...
class UserStatisticsManager {
   ...
   */
  protected ?EntityStorageInterface $userModuleStatusStorage = NULL;
   ...
   * @var \Drupal\Core\Entity\EntityStorageInterface|null
   */
  public ?EntityStorageInterface $termStorage = NULL;
  ...
  public static function getDefaultUserPicture(?UserInterface $user = NULL): array {
    $path = \Drupal::service('extension.list.theme')->getPath('aristotle') . '/dist/images/content/profil.svg';
