(function ($, Drupal) {
  Drupal.behaviors.opignoStatisticsUser = {
    attach: function (context) {
      const $training_details_link = $(once('click', '.trainings-list .training a.details', context));
      let baseUrl = drupalSettings.path.baseUrl ? drupalSettings.path.baseUrl : '/';
      $training_details_link.click(function (e) {
        e.preventDefault();
        ...
        if ($training_details.length === 0) {
          if (!$this.attr('data-ajax-loading')) {
            ...
            Drupal.ajax({
              url: baseUrl + `ajax/statistics/user/${user_id}/training/${training_id}`,
            }).execute()
                .done(() => {
                  const $training_active = $table.find(active_selector);
                  const $training_details = $table.find(details_selector);
      ...
      const $trainings_list = $(once('click_training_close', '.trainings-list', context));
      const $trainings_list_open = $(once('click_course_open', '.trainings-list', context));
      const $trainings_list_close = $(once('click_course_close', '.trainings-list', context));

      $trainings_list.on('click', '.training-active .training-close', function (e) {
        e.preventDefault();
      ...
      $trainings_list_open.on('click', '.course .course-details-open', function (e) {
        e.preventDefault();
        ...
        if ($course_details.length === 0) {
          if (!$this.attr('data-ajax-loading')) {
            $this.attr('data-ajax-loading', true);
            Drupal.ajax({
              url: baseUrl + `ajax/statistics/user/${user_id}/training/${training_id}/course/${course_id}`,
            }).execute()
                .done(() => {
                  const $course_active = $table.find(active_selector);
                  const $course_details = $table.find(details_selector);
      ...
      $trainings_list_close.on('click', '.course-active .course-close', function (e) {
        e.preventDefault();
      ...
      $(once('click_training_module_open', '.trainings-list', context)).on('click', '.training-module-details-open', function (e) {
        e.preventDefault();
        ...
        if ($panel.length === 0) {
          if (!$this.attr('data-ajax-loading')) {
            $this.attr('data-ajax-loading', true);
            Drupal.ajax({
              url: baseUrl + `ajax/statistics/user/${user}/training/${training}/module/${module}`,
            }).execute()
                .done(() => {
      ...
      $(once('click_course_module_open', '.trainings-list', context)).on('click', '.course-module-details-open', function (e) {
        e.preventDefault();
        ...
        if ($panel.length === 0) {
          if (!$this.attr('data-ajax-loading')) {
            $this.attr('data-ajax-loading', true);
            Drupal.ajax({
              url: baseUrl + `ajax/statistics/user/${user}/training/${training}/course/${course}/module/${module}`,
            }).execute()
                .done(() => {
                  $wrapper.find(panelSelector).show();
                })
      ...
      $(once('click_module_close', '.trainings-list', context)).on('click', '.module_panel_close', function (e) {
        e.preventDefault();
