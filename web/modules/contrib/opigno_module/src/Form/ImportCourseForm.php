  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if (in_array('list_of_files.json', $files)) {
      ...
      $new_course = Group::create([
        ...
        'field_guided_navigation' => $course_content['field_guided_navigation'][0]['value'] ?? NULL,
      ]);
      ...
      foreach ($content['modules'] as $module_name => $module_path) {
        ...
        $new_module = OpignoModule::create([
          ...
          'random_activity_score' => $module_content['random_activity_score'][0]['value'] ?? NULL,
        ...
        $parent_links = $module_content['parent_links'] ?? NULL;
