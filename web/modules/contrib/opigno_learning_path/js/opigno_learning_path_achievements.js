(function ($, Drupal) {
  Drupal.behaviors.opignoLearningPathAchievements = {
    attach: function (context) {
      var $detailsShow = $(once('detailsShow', '.lp_details_show', context));
      var $detailsHide = $(once('detailsHide', '.lp_details_hide', context));
      var $lpStepTitleWrapper = $(once('clickWrapper', '.lp_step_title_wrapper', context));

      $lpStepTitleWrapper.click(function () {
      ...
      var $moduleRow = $(once('moduleRow', '.lp_course_steps tr td:nth-child(4) a', context));
      $moduleRow.click(function (e) {
        e.preventDefault();
      ...
      var $moduleStep = $(once('moduleStep', '.lp_step_content_module .lp_step_summary_clickable', context));
      $moduleStep.click(function (e) {
        e.preventDefault();
      ...
      var $modulePanelClose = $(once('modulePanelClose', '.lp_module_panel_close', context));
      $modulePanelClose.click(function (e) {
        e.preventDefault();
      ...
      var noResult = false;
      var $window = $(once('scroll', window, context));
      var that = this;
    ...
    timeLineSlider: function (context) {
      $(once('timeLineSlider', '.lp_timeline', context)).each(function () {
        var $timeLine = $(this);
