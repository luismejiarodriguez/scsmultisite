(function ($, Drupal, drupalSettings) {
  Drupal.behaviors.opignoLearningPathCreateMember = {
    attach: function (context, settings) {
      ...
      var $class_users_autocomplete = $(once('autocompleteselect', '#class_users_autocomplete', context));
      var $class_users_response = $(once('autocompleteresponse', '#class_users_autocomplete', context));
      ...
      var $select_all = $(once('click', '#select_all', context));
      $select_all
          .on('click', function (e) {
            e.preventDefault();
